...
# Dishes — curated selection of iconic Algerian dishes with authentic images
# from Wikimedia Commons (CC-BY-SA 4.0).
# Each entry: (name, description, price_dzd, prep_min, popularity, image_url)
DISHES = {
    "Entrées": [
        (
            "Chourba Frik",
            ...
            15,
            4.8,
            "https://upload.wikimedia.org/wikipedia/commons/5/57/Chorba_frik_de_T%C3%A9bessa.jpg",
        ),
        (
            "Bourek Annabi",
            ...
            10,
            4.9,
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQky0lBXzx-rntHDhzX7l7LNZson4daknGItw&s",
        ),
    ],
    "Plats Principaux": [
        (
            ...
            30,
            4.9,
            "https://www.madrange.fr/wp-content/uploads/2019/04/couscous-royal-poulet-merguez-2023.jpg",
        ),
        (
            "Chakhchoukha",
            ...
            40,
            4.8,
            "https://upload.wikimedia.org/wikipedia/commons/9/97/Chakhchoukha.jpg",
        ),
        (
            "Rechta",
            ...
            35,
            4.9,
            "https://www.dzirielle.com/saveurs/plats-algeriens/rechta-algeroise.webp",
        ),
    ],
    "Pâtisseries": [
        (
            ...
            for ci, (cn, cd, _) in enumerate(MENU_CATEGORIES):
                if cn in DISHES:
                    ...
                    for di, dish_data in enumerate(DISHES[cn]):
                        name, desc, price, prep, popular, image_url = dish_data
